...
inline double random_normal(bitgen_t *bitgen_state, double loc, double scale)
{
  return loc + scale * random_standard_normal(bitgen_state);
}

inline double random_exponential(bitgen_t *bitgen_state, double scale)
{
  return scale * random_standard_exponential(bitgen_state);
}

inline double random_uniform(bitgen_t *bitgen_state, double lower, double range)
{
