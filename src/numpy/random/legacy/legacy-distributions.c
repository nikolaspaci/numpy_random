...
inline double legacy_normal(aug_bitgen_t *aug_state, double loc, double scale)
{
  return loc + scale * legacy_gauss(aug_state);
}

inline double legacy_lognormal(aug_bitgen_t *aug_state, double mean, double sigma)
{
